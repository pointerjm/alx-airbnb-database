...
EXPLAIN ANALYZE SELECT * FROM bookings WHERE start_date >= '2025-09-01' AND start_date <= '2025-09-30';
...
EXPLAIN ANALYZE SELECT p.* FROM properties p JOIN users u ON p.host_id = u.user_id WHERE u.email = 'bob.johnson@example.com';
